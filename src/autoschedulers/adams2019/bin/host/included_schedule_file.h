#ifndef HALIDE__bin___host___included_schedule_file_h
#define HALIDE__bin___host___included_schedule_file_h
#include <stdint.h>
...
int included_schedule_file(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_filter_buffer, struct halide_buffer_t *_bias_buffer, struct halide_buffer_t *_relu_buffer);

HALIDE_FUNCTION_ATTRS
int included_schedule_file_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *included_schedule_file_metadata();
